...
gem 'lims-core', '~>1.5.0.0.0', :git => 'http://github.com/sanger/lims-core.git' , :branch => 'development'
# gem 'lims-core', '~>1.4.1.0.6', :path => '../lims-core'
gem 'lims-api', '~>1.2.0.2.3', :git => 'http://github.com/sanger/lims-api.git' , :branch => 'development'
