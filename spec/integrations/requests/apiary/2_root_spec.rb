...
describe "root" do
  ...
  # Support App can be performed browsing this JSON response.
    ...
    "user_sessions": {
        "actions": {
            "create": "http://example.org/user_sessions",
            "read": "http://example.org/user_sessions",
            "first": "http://example.org/user_sessions/page=1",
            "last": "http://example.org/user_sessions/page=-1"
        }
    },
    "revisions": {
        "actions": {
            "create": "http://example.org/revisions",
            "read": "http://example.org/revisions",
            "first": "http://example.org/revisions/page=1",
            "last": "http://example.org/revisions/page=-1"
        }
    },
    "create_barcodes": {
        "actions": {
